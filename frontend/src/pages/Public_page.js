...
export const Public_page = () => {
  ...
  <nav className="hidden md:block">
    <ul className="flex gap-8 text-sm font-medium">
          ...
          >
            ...
            <span 
              className={`
                ...
                ${activeItem === item.toLowerCase() ? 'scale-x-100' : 'scale-x-0'}
              `}
            />
          </a>
        </li>
      ...
      >
        {/* Icons */}
        <img src={icon1} alt="CO2" className="absolute top-20 left-1/4 w-16 h-16 drop-shadow-lg" />
        <img src={icon2} alt="Gas" className="absolute top-1/2 left-16 w-14 h-14 drop-shadow-lg" />
        <img src={icon3} alt="Temperature" className="absolute bottom-32 left-1/3 w-12 h-12 drop-shadow-lg" />
        <img src={icon4} alt="Weather" className="absolute top-24 right-1/4 w-14 h-14 drop-shadow-lg" />
        <img src={icon5} alt="Value" className="absolute bottom-28 right-1/3 w-12 h-12 drop-shadow-lg" />
        <img src={icon6} alt="PM2.5" className="absolute bottom-16 right-20 w-16 h-16 drop-shadow-lg" />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg max-w-3xl mx-auto">
              Chúng tôi là nền tảng giám sát chất lượng không khí hàng đầu, 
              mang đến giải pháp toàn diện cho mọi không gian sống và làm việc.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Xây dựng một nền tảng giám sát chất lượng không khí đáng tin cậy, 
                thời gian thực, giúp mọi người hiểu rõ môi trường xung quanh và có 
                hành động kịp thời để bảo vệ sức khỏe của chính mình và những người thân yêu.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl border hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-gray-600">Đo lường đầy đủ các chỉ số PM2.5, PM10, CO₂, nhiệt độ, độ ẩm theo thời gian thực</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl border hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-gray-600">Tự động gửi thông báo khi phát hiện chỉ số vượt ngưỡng an toàn</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl border hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-gray-600">Phân tích dữ liệu và tạo báo cáo chuyên sâu về chất lượng không khí</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* ================= WHY ================= */}
      <section id="why" className="py-24 bg-gradient-to-b from-white to-[#f6f6f6]">
  <div className="max-w-7xl mx-auto px-[10%]">
    ...
    <div className="text-center mb-16">
      ...
      <p className="text-lg text-gray-600 max-w-3xl mx-auto">
        Không khí sạch là yếu tố thiết yếu cho sức khỏe và cuộc sống của chúng ta
      </p>
    </div>
      ...
      <div className="space-y-8">
        <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Không khí sạch giúp giảm nguy cơ mắc các bệnh về đường hô hấp, tim mạch và các vấn đề sức khỏe khác.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold mb-2">Nâng cao chất lượng sống</h3>
              <p className="text-gray-600">Môi trường không khí tốt giúp cải thiện giấc ngủ, tăng cường sự tập trung và nâng cao chất lượng cuộc sống.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-8">
        <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold mb-2">Môi trường làm việc tốt hơn</h3>
              <p className="text-gray-600">Không khí sạch tạo môi trường làm việc tích cực, giúp tăng khả năng tập trung và hiệu suất làm việc.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Giám sát và cải thiện chất lượng không khí là bước đi quan trọng hướng tới tương lai bền vững.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="mt-16 text-center">
      <a href="#features" className="inline-flex items-center gap-2 bg-black text-white px-8 py-4 rounded-full hover:bg-gray-800 transition-colors">
        <span className="font-semibold">Khám phá giải pháp của chúng tôi</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight">
              Thu thập và hiển thị dữ liệu từ <br className="hidden sm:block" /> thiết bị IoT theo thời gian thực
            </h2>
            <p className="mt-4 text-gray-600 text-lg max-w-xl">
              Hệ thống có thể thu thập dữ liệu từ môi trường và hiển thị theo thời gian thực.
            </p>
          </div>
          <div className="relative h-[280px] lg:h-[340px] overflow-visible">
            <div className="absolute left-6 bottom-2 w-[90%] rounded-2xl overflow-hidden shadow-md ring-1 ring-gray-100">
              <img src={anh1} alt="Chart" className="w-full h-auto object-contain" />
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="rounded-2xl bg-white shadow-md ring-1 ring-gray-200 p-6 flex items-center justify-between gap-6">
            <div className="max-w-sm">
              <h3 className="text-xl font-semibold mb-3">Cảnh báo người dùng</h3>
              <p className="text-gray-600">Thông báo nếu phát hiện lỗi.</p>
            </div>
            <img src={anh2} alt="Alert" className="w-40 h-auto object-contain" />
          </div>
          <div className="rounded-2xl bg-white shadow-md ring-1 ring-gray-200 p-6 flex items-center justify-between gap-6">
            <div className="max-w-sm">
              <h3 className="text-xl font-semibold mb-3">Cấu hình ngưỡng an toàn</h3>
              <p className="text-gray-600">Người dùng tùy chỉnh mức ngưỡng.</p>
            </div>
            <img src={anh3} alt="Threshold" className="w-40 h-auto object-contain" />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white px-[10%]" id="prices">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-extrabold text-center mb-12">Bảng giá dịch vụ</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-xl border hover:shadow-xl transition">
              ...
              <button className="w-full py-3 rounded-lg bg-black text-white font-semibold hover:bg-gray-800">Chọn gói</button>
            </div>

            <div className="p-8 rounded-xl border border-blue-500 shadow-xl relative">
              <div className="absolute top-0 right-0 bg-blue-500 text-white px-3 py-1 rounded-bl-lg rounded-tr-lg text-sm">Phổ biến</div>
              ...
              <button className="w-full py-3 rounded-lg bg-blue-500 text-white font-semibold hover:bg-blue-600">Chọn gói</button>
            </div>
      ...
      <section id="contact" className="py-20 bg-[#f6f6f6] flex justify-center">
        <div className="w-full max-w-3xl">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-gray-600">Leave your info and we’ll get back shortly.</p>
          </div>
          ...
          <form className="bg-white rounded-xl border shadow-sm p-6 flex flex-col md:flex-row flex-wrap gap-4 items-center justify-center">
            <input type="text" placeholder="Your Name" className="flex-1 min-w-[180px] rounded-lg border px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#b99e38]" />
            <input type="email" placeholder="you@example.com" className="flex-1 min-w-[220px] rounded-lg border px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#b99e38]" />
            <input type="tel" placeholder="+84-your phone number" className="flex-1 min-w-[180px] rounded-lg border px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#b99e38]" />
            <button type="submit" className="w-full md:w-auto bg-green-600 text-white font-semibold px-6 py-3 rounded-lg hover:bg-green-700 transition">
              Send Info
            </button>
          </form>
        </div>
