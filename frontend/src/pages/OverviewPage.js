...
const imgOverviewHome = "http://localhost:3845/assets/e0bc495b29ca2c7486c8a524d517cae08c17c718.png";
const imgUser = "http://localhost:3845/assets/368efa59fd16babbf15403d8ccb0018a8c34c24f.png";
const imgSquaresFour = "http://localhost:3845/assets/fc85b8eed6f9b7a5e846d893c7088544a02a370f.svg";
const imgUsers = "http://localhost:3845/assets/0dfef28bb4c502b5b9d516b447e1d2dadcea6e78.svg";
const imgHeadset = "http://localhost:3845/assets/2551b38a560ea1c7618c7519c5ca6ce99d7113aa.svg";
const imgBellSimpleRinging = "http://localhost:3845/assets/53032b04e957d0b4d6c13ae769b73374022bd275.svg";
const imgGear = "http://localhost:3845/assets/4f898509feaf42e53c012e8dfc3d67534c106a85.svg";
const imgCloudMoon = "http://localhost:3845/assets/37ecf27d7ce7ff3d37d1b20538a5c422eefe0a4d.svg";
const imgVector1 = "http://localhost:3845/assets/604f7939ca8a0ce2ec2c57d797d18bb95c096c16.svg";
const imgNofication = "http://localhost:3845/assets/709a11fbcce0b14163f802e5a3e3eef428ecca60.svg";
const imgSignOut = "http://localhost:3845/assets/3131933941177fcf1a00346b442de4fd647c055a.svg";
const imgArrowUpRight = "http://localhost:3845/assets/2427909afe2a97e27ef41540363fb720e236ff9b.svg";
...
const OverviewPage = () => {
  ...
  return (
    ...
    >
          ...
          <div className="flex flex-col gap-[50px] items-start justify-start w-full">
            {menuItems.map((item) => (
              ...
              >
                ...
                <div className={`font-['Inter:Regular',_sans-serif] font-normal leading-[0] not-italic text-[18px] text-nowrap ${
                  item.isActive ? 'text-black' : 'text-[#969696]'
                }`}>
                  <p className="leading-[normal] whitespace-pre">{item.label}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* Top Navigation Bar */}
      <div className="absolute bg-white flex gap-[35px] items-center justify-end p-[23px] rounded-[30px] shadow-[1px_5px_20px_0px_rgba(0,0,0,0.1)] top-[50px] w-[1385px]" style={{ left: "calc(16.667% + 25px)" }}>
          ...
          <div className="flex gap-[11px] items-center justify-start">
            <div className="flex gap-1 items-center justify-start">
              <div className="relative shrink-0 size-6">
                <img alt="Weather" className="block max-w-none size-full" src={imgCloudMoon} />
              </div>
            ...
            <div className="h-5 w-0 relative">
              <div className="absolute bottom-0 left-[-0.5px] right-[-0.5px] top-0">
                <img alt="Divider" className="block max-w-none size-full" src={imgVector1} />
              </div>
            </div>
            <div className="font-['Inter:Regular',_sans-serif] font-normal leading-[0] not-italic text-[#969696] text-[18px] text-nowrap">
              <p className="leading-[normal] whitespace-pre">{getCurrentDate()}</p>
            </div>
          </div>
        </div>
        ...
        <div className="relative shrink-0 size-[70px] cursor-pointer">
          <img alt="Notifications" className="block max-w-none size-full" src={imgNofication} />
        </div>
        ...
        <div className="bg-[#f6f6f6] flex gap-2.5 h-[70px] items-center justify-center p-[25px] rounded-[999px] w-[230px]">
          <div className="font-['Inter:Medium',_sans-serif] font-medium leading-[0] not-italic text-[18px] text-black text-nowrap">
            <p className="leading-[normal] whitespace-pre">Xin chào, {currentUser} 👋</p>
          </div>
        </div>

        {/* User Avatar */}
        <div className="relative shrink-0 size-[70px] cursor-pointer">
          <img alt="User Avatar" className="block max-w-none size-full rounded-full" height="70" src={imgUser} width="70" />
        </div>
      </div>
      ...
      <div className="absolute font-['Inter:Semi_Bold',_sans-serif] font-semibold leading-[0] left-[91px] not-italic text-[36px] text-black text-nowrap top-20">
        <p className="leading-[normal] whitespace-pre">
          <span>Air</span>
          <span className="font-['Inter:Semi_Bold_Italic',_sans-serif] font-semibold italic text-[#969696]">Zen</span>
        </p>
      </div>

      {/* Logout Button */}
      <div className="absolute bottom-[79px] flex items-center justify-center left-[83px] size-6 cursor-pointer" onClick={handleLogout}>
        <div className="flex-none rotate-[180deg] scale-y-[-100%]">
          <div className="relative size-6">
            <img alt="Logout Icon" className="block max-w-none size-full" src={imgSignOut} />
          </div>
        </div>
      </div>
      <div className="absolute bottom-[102px] font-['Inter:Regular',_sans-serif] font-normal leading-[0] left-28 not-italic text-[#969696] text-[18px] text-nowrap translate-y-[100%] cursor-pointer" onClick={handleLogout}>
      ...
      {environmentData.map((card) => (
        ...
        >
          ...
          <div className="absolute flex gap-2.5 items-center justify-center left-[188px] p-[7px] rounded-[22.5px] size-[45px] top-[19px] hover:bg-gray-50 transition-colors">
            ...
            <div className="relative shrink-0 size-6">
              <img alt="Expand" className="block max-w-none size-full" src={imgArrowUpRight} />
            </div>
          </div>
        </div>
      ))}
