...
const Setting = () => {
  ...
  const settingItems = [
    { id: "data-collection", title: "Thu thập dữ liệu", icon: ChartLine },
    { id: "security", title: "Bảo mật", icon: Shield },
    { id: "notifications", title: "Thông báo", icon: Bell },
    { id: "interface", title: "Giao diện", icon: Palette },
  ];
...
const SettingCard = ({ item }) => {
  ...
  return (
    <button
      onClick={() => console.log(`Mở ${item.title}`)}
      className="
