...
const menuItems = [
  { key: "Overview", label: "Overview", icon: require("../../image/overview.png"), path: "/" },
  { key: "QuanLyUser", label: "Quản lý người dùng", icon: require("../../image/Chisokk.png"), path: "/air-quality" },
  { key: "QuanLyThietBi", label: "Quản lý thiết bị", icon: require("../../image/NguongAnToan.png"), path: "/threshold" },
  { key: "YCHT", label: "Yêu cầu hỗ trợ", icon: require("../../image/NguongAnToan.png"), path: "/threshold" },
  { key: "ThongBao", label: "Quản lý thông báo", icon: require("../../image/LichSu.png"), path: "/history" },
  { key: "CaiDat", label: "Cài đặt", icon: require("../../image/CaiDat.png"), path: "/settings" },
];
